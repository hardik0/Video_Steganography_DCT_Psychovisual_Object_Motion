...
def embed_message(video_path, message, output_path, locations_file, repetition_factor=5, format_preset="default"):
    """Embed message into video using DCT-based steganography with motion analysis
    ...
    for frame_idx, frame in enumerate(frames, 1):  # Start frame numbers from 1
        ...
        if bit_index < message_length:
            ...
            if prev_frame is not None and frame_idx > 1:
                ...
                blocks = select_motion_blocks(prev_frame, frame, max_blocks=5)
...
if __name__ == "__main__":
    ...
    embed_message(args.input_video, args.message, args.output_video, args.locations_file, args.repetition, args.format) 